...
static const char *fonts[]          = { "Hack Nerd Font:style=Regular:size=10", "Microsoft YaHei:style=Regular:size=10" };
static const char dmenufont[]       = "文泉驿微米黑:style=Regular:size=10";
